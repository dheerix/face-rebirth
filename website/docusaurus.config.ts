...
const config: Config = {
  ...
  trailingSlash: false,
  onBrokenLinks: 'throw',
  headTags: [{tagName: 'link', attributes: {rel: 'canonical', href: 'https://dheerix.github.io/face-rebirth/'}}],
  ...
  themeConfig: {
    ...
    metadata: [
      ...
      {property: 'og:url', content: 'https://dheerix.github.io/face-rebirth/'},
    ...
    navbar: {
      ...
      hideOnScroll: false,
      items: [
        {href: 'https://dheerix.github.io/face-rebirth/#why', label: 'Why Face Rebirth', position: 'left'},
        {href: 'https://dheerix.github.io/face-rebirth/#method', label: 'The Method', position: 'left'},
        {href: 'https://dheerix.github.io/face-rebirth/#program', label: '21-Day Reset', position: 'left'},
        {href: 'https://dheerix.github.io/face-rebirth/#founder', label: 'Meet the Founder', position: 'left'},
        {to: '/resources', label: 'Resources', position: 'left'},
        {href: 'https://dheerix.github.io/face-rebirth/#waitlist', label: 'Join the Waitlist', position: 'right', className: 'navbar-cta'},
      ],
    },
    footer: {
      style: 'dark',
      links: [
        ...
        {title: 'Explore', items: [{label: 'The Method', href: 'https://dheerix.github.io/face-rebirth/#method'}, {label: '21-Day Reset', href: 'https://dheerix.github.io/face-rebirth/#program'}, {label: 'Free Resources', to: '/resources'}]},
        {title: 'Learn', items: [{label: 'Brand Philosophy', href: 'https://dheerix.github.io/face-rebirth/#why'}, {label: 'Documentation', to: '/docs/welcome'}]},
        {title: 'Connect', items: [{label: 'Join the Waitlist', href: 'https://dheerix.github.io/face-rebirth/#waitlist'}, {label: 'Instagram — Coming Soon', href: 'https://dheerix.github.io/face-rebirth/#waitlist'}, {label: 'Discovery Call — Coming Soon', href: 'https://dheerix.github.io/face-rebirth/#call'}]},
      ],
